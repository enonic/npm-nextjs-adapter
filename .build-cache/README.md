...
The `enonic-react-components-0.0.0-issue-285-ba56689.tgz` file is a pre-built version of the `@enonic/react-components` package from the `issue-285` branch:
- Source: https://github.com/enonic/npm-react-components/tree/issue-285
- Commit: ba56689 (ba566891a8bbb5e516ab618b8d0da7cfe71deb35)
...
4. Pack the built package: `npm pack`
5. Copy the generated tarball to this directory
6. Update package.json if the filename changed
